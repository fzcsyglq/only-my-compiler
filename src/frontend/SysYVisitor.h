...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitStmtAssignment(SysYParser::StmtAssignmentContext *context) = 0;
    ...
    virtual antlrcpp::Any visitStmtIf(SysYParser::StmtIfContext *context) = 0;
